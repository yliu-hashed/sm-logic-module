...
EXTRACT_REPORT_FROM_BP = $(patsubst blueprints/%.json,reports/%.json,$(1))
...
ADD_C2_EXTRACT_WIDTH = $(patsubst tmp/add_comb_2i_%_synth.json,%,$(1))
...
ADD_C3_EXTRACT_WIDTH = $(patsubst tmp/add_comb_3i_%_synth.json,%,$(1))
...
ADD_C4_EXTRACT_WIDTH = $(patsubst tmp/add_comb_4i_%_synth.json,%,$(1))
...
MUL_CT_EXTRACT_WIDTH = $(patsubst tmp/mul_comb_trunc_%_synth.json,%,$(1))
...
MUL_CFS_EXTRACT_WIDTH = $(patsubst tmp/mul_comb_full_signed_%_synth.json,%,$(1))
...
MUL_CFU_EXTRACT_WIDTH = $(patsubst tmp/mul_comb_full_unsigned_%_synth.json,%,$(1))
...
MUL_CFM_EXTRACT_WIDTH = $(patsubst tmp/mul_comb_full_mixed_%_synth.json,%,$(1))
...
DIV_CS_EXTRACT_WIDTH = $(patsubst tmp/div_comb_signed_%_synth.json,%,$(1))
...
DIV_CU_EXTRACT_WIDTH = $(patsubst tmp/div_comb_unsigned_%_synth.json,%,$(1))
...
REM_CS_EXTRACT_WIDTH = $(patsubst tmp/rem_comb_signed_%_synth.json,%,$(1))
...
REM_CU_EXTRACT_WIDTH = $(patsubst tmp/rem_comb_unsigned_%_synth.json,%,$(1))
...
SQRT_C_EXTRACT_WIDTH = $(patsubst tmp/sqrt_comb_%_synth.json,%,$(1))
...
SQR_CT_EXTRACT_WIDTH = $(patsubst tmp/sqr_comb_trunc_%_synth.json,%,$(1))
...
SQR_CFS_EXTRACT_WIDTH = $(patsubst tmp/sqr_comb_full_signed_%_synth.json,%,$(1))
...
SQR_CFU_EXTRACT_WIDTH = $(patsubst tmp/sqr_comb_full_unsigned_%_synth.json,%,$(1))
...
CMP_C_EXTRACT_WIDTH = $(patsubst tmp/cmp_comb_%_synth.json,%,$(1))
...
PENC_CX_EXTRACT_WIDTH = $(patsubst tmp/penc_comb_max_%_synth.json,%,$(1))
...
PENC_CN_EXTRACT_WIDTH = $(patsubst tmp/penc_comb_min_%_synth.json,%,$(1))
...
MUL_ST_EXTRACT_WIDTH = $(patsubst tmp/mul_seq_trunc_%_synth.json,%,$(1))
...
DIV_SU_EXTRACT_WIDTH = $(patsubst tmp/div_seq_unsigned_%_synth.json,%,$(1))
...
BCD2BIN_C_EXTRACT_WIDTH = $(patsubst tmp/bcd2bin_comb_%_synth.json,%,$(1))
...
BIN2BCD_C_EXTRACT_WIDTH = $(patsubst tmp/bin2bcd_comb_%_synth.json,%,$(1))
...
MEM_TIMER_1R1W_EXTRACT_TYPE = $(patsubst tmp/mem_timer_1r1w_%_synth.json,%,$(1))
...
MEM_TIMER_2R1W_EXTRACT_TYPE = $(patsubst tmp/mem_timer_2r1w_%_synth.json,%,$(1))
...
MEM_TIMER_3R1W_EXTRACT_TYPE = $(patsubst tmp/mem_timer_3r1w_%_synth.json,%,$(1))
...
MEM_TIMER_4R1W_EXTRACT_TYPE = $(patsubst tmp/mem_timer_4r1w_%_synth.json,%,$(1))
...
MEM_XORDFF_1R1W_EXTRACT_TYPE = $(patsubst tmp/mem_xordff_1r1w_%_synth.json,%,$(1))
...
MEM_XORDFF_2R1W_EXTRACT_TYPE = $(patsubst tmp/mem_xordff_2r1w_%_synth.json,%,$(1))
...
MEM_XORDFF_3R1W_EXTRACT_TYPE = $(patsubst tmp/mem_xordff_3r1w_%_synth.json,%,$(1))
...
MEM_XORDFF_4R1W_EXTRACT_TYPE = $(patsubst tmp/mem_xordff_4r1w_%_synth.json,%,$(1))
...
DISP_EXTRACT_TYPE = $(patsubst tmp/disp_%_synth.json,%,$(1))
